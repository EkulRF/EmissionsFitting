...
with open('/home/luke/lukeflamingradis/EmFit_private/results/C.pickle', 'rb') as handle:
    C = pkl.load(handle)
...
# lasso_inversion = np.load('/home/luke/lukeflamingradis/EmFit_private/results/lasso_evaluation.npy', allow_pickle=True).item()
